    ...
    try:
        users_data = [
            ...
            },
            {
                ...
                "full_name": "Team Manager One",
                "password": "manager123",
            },
            {
                "username": "manager2",
                "email": "manager2@team.com",
                "full_name": "Team Manager Two",
                "password": "manager123",
            },
            {
                "username": "coach1",
                "email": "coach1@team.com",
            ...
            },
            {
                ...
                "full_name": "Chief Referee Johnson",
                "password": "ref123",
            },
        ]
    ...
    try:
        teams_data = [
            ...
            },
            {
                ...
                "coach_name": "Eddie Howe",
                "founded_year": 1892,
                "home_ground": "St. James' Park",
            },
            {
                "name": "Brighton & Hove Albion",
                "coach_name": "Roberto De Zerbi",
                "founded_year": 1901,
                "home_ground": "Amex Stadium",
            },
        ]
        ...
        coaches_data = [
            {
                ...
                "name": "Erik ten Hag",
                "experience_years": 15,
                "specialization": "Tactical Innovation",
                "nationality": "Dutch",
            },
            {
                "team_id": 2,
            ...
            },
            {
                ...
                "name": "Jürgen Klopp",
                "experience_years": 20,
                "specialization": "High-Intensity Football",
                "nationality": "German",
            },
            {
                "team_id": 4,
                "name": "Pep Guardiola",
                "experience_years": 18,
                "specialization": "Possession Football",
                "nationality": "Spanish",
            },
            {
                "team_id": 5,
    ...
    try:
        referees_data = [
            ...
            },
            {
                ...
                "experience_years": 7,
                "nationality": "English",
                "qualification_level": "Championship",
            },
        ]
    ...
    try:
        ...
        matches_data = [
            ...
            },
            {
                "team_a_id": 4,
                "team_b_id": 1,
                "match_date": base_date + timedelta(days=8),
            ...
            },
            {
                "team_a_id": 6,
                "team_b_id": 7,
                "match_date": base_date + timedelta(days=9),
        ...
        sponsors_data = [
            {
                ...
                "sponsorship_amount": 500000,
            },
            {
                "name": "Adidas",
                "industry": "Sports Apparel",
                "sponsorship_amount": 450000,
            },
            {
                "name": "Emirates Airlines",
                "industry": "Aviation",
                "sponsorship_amount": 600000,
            },
            {
                "name": "Etihad Airways",
                "industry": "Aviation",
                "sponsorship_amount": 550000,
            },
            {
                "name": "TeamViewer",
                "industry": "Technology",
